  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="modal-save" action="proses_pimpinan.php?page=edit" name="modal_popup" enctype="multipart/form-data" method="post" role="form">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input name="pendidikan" type="text" class="form-control" id="pend" value="<?php echo $row['pendidikan']?>">
            </div>
