...
<head>
  ...
  <title> Data Kinerja | BKP Kota Tangerang</title>
...
<div class="wrapper">
  <div class="main-header">
    ...
    <a href="../home.php" class="logo">
      ...
      <span class="logo-mini"><b>BKP</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>BKP </b>Kota Tangerang</span>
    </a>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  ...
                  <small>BKP Kota Tangerang</small>
                </p>
              </li>
              <!-- Menu Footer-->
                  ...
                  <select class="form-control" name="namapegawai" onChange="disable()" required>
                    ...
                    ?>
                      <option value="<?php echo $row['nama'];?>"> 
                        <?php echo $row['nama'];?>  ||  <?php echo $row['jabatan']; ?> || <?= $row['nip'];?>
                      </option>
                    <?php 
                      } 
                    ?>
