...
<div class="wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
       <!--  <li class="header">MAIN NAVIGATION</li> -->
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="naik_jabatan.php"><i class="fa fa-file-text"></i> Jabatan Pimpinan</a></li>
  ...
  <div class="content-wrapper"> 
    ...
    <section class="content-header">
      <h1>
        Kenaikan Jabatan Pimpinan
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li>Data Kenaikan Jabatan Pimpinan</li>
      </ol>
    </section>
<!-- <?php 
      ...
      <div class="row">
        <div class="col-xs-6 col-md-offset-3">
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" method="post" action="../session/session.php?id=naikjabatan">

                <div class="form-group">
                  <label>Nama</label>
                  <select id="nm_pimpinan" class="form-control" name="nm_pimpinan" onchange="changeValue(this.value)" required>
                    <option value="">---Pilih---</option>
                    <?php
                    include '../config/koneksi.php';
                    $result = mysqli_query($koneksi, "SELECT * FROM tbl_pimpinan");
...
<script>    
<?php echo $jsArray ?>  
  function changeValue(nm_pimpinan){  
    document.getElementById('tampil_jabatan').value = data[nm_pimpinan].jabatan;  
    document.getElementById('tampil_gol').value = data[nm_pimpinan].golongan;  
    document.getElementById('tampil_pangkat').value = data[nm_pimpinan].pangkat;
  };  
</script> 
