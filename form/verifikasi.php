...
$_SESSION['kode'] =$verif;//utk ngirim ke sessionverif
  	...
  	<div class="panel-body">
			<form role="form" name="verify" method="post" action="../session/sessionverify.php?id=<?php echo $id ?>">
				<fieldset>
					...
					<h4>Silahkan cek sms dan masukan kode verifikasi dibawah ini!</h4>
					...
					<input type="submit" class="btn btn-primary active" name="submit" value="Verifikasi"/>
						<table style="float:right;">
							<td><a href="../session/session.php?id=again&user=<?php echo $user ?>" class="btn-user" style="margin-right: 25px;text-decoration:none;margin-left: 7px;">Tidak SMS? Kirim Ulang</a></td>
						</table>
				</fieldset>
			</form>
	</div>
