...
$id = $_GET["id"];
 ...
 $sql = mysqli_query($koneksi, "SELECT akun.username,akun.password,akun.nama,akun.no_hp, tbl_pimpinan.* FROM akun INNER JOIN tbl_pimpinan ON akun.nama = tbl_pimpinan.nama WHERE tbl_pimpinan.nama = '$id' ");
if($sql == false){
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="modal-save" action="pimpinan/proses_update.php?page=edit" name="modal_popup" enctype="multipart/form-data" method="post" role="form">
          ...
          <!-- <div class="form-group">
              <label for="kdpegawai">Kode Pimpinan</label>
              <input name="kdpegawai" type="text" class="form-control" id="kdpegawai" value="<?php echo $row['kd_pimpinan']; ?>" readonly>
          </div> -->
          ...
          <div class="form-group">
            ...
            <!-- <div class="form-group">
              ...
              <select class="form-control" name="jabatan" required>
                <?php
                $sql = mysqli_query($koneksi, "SELECT * FROM tbl_pimpinan WHERE nama='$id'");
                while ($row = mysqli_fetch_array($sql)){
                ?>
            ...
            <div class="form-group">
              <label>Foto</label>
              <?php
                $sql = mysqli_query($koneksi, "SELECT foto FROM tbl_pimpinan WHERE nama='$id' ");
                while ($row = mysqli_fetch_array($sql)){
                ?>
                <div><img src="img/<?php echo $row['foto'];?>" width='30%'></div>
                <?php } ?>
