  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="modal-save" action="pegawai/proses_pegawai.php?page=edit" name="modal_popup" enctype="multipart/form-data" method="post" role="form">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
              <label for="pen">Pendidikan Terakhir</label>
            ...
            <div class="form-group">
              <label>Foto</label>
              <?php
                $sql = mysqli_query($koneksi, "SELECT foto FROM tbl_pegawai WHERE nama='$id' ");
                while ($row = mysqli_fetch_array($sql)){
                ?>
