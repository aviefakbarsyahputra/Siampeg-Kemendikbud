...
<head>
  ...
  <title>Histori Cuti | Biro SDM KEMDIKBUD</title>
  ...
  <div class="content-wrapper"> 
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Histori Cuti</li>
      </ol>
    </section>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php
                    ...
                    $sql = mysqli_query($koneksi,"SELECT * FROM tbl_cuti WHERE nama='$_SESSION[nama]' ");
                    if($sql==false){
